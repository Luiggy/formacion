...
then
	cd /opt
	unzip /mnt/liferay/liferay-portal-tomcat-6.2-ce-ga6-20160112152609836.zip
...
then
	cp /mnt/liferay/dev.portal-ext.properties /opt/liferay/tomcat-7.0.62/webapps/ROOT/WEB-INF/classes/portal-ext.properties
	cp /mnt/liferay/undeploy-ext.sh /opt/liferay/undeploy-ext.sh
	cp /mnt/tomcat/context.xml /opt/liferay/tomcat-7.0.62/conf/
	cp /mnt/tomcat/server.xml /opt/liferay/tomcat-7.0.62/conf/
	cp /mnt/tomcat/setenv.sh /opt/liferay/tomcat-7.0.62/bin/
	cp /mnt/tomcat/catalina-jmx-remote.jar /opt/liferay/tomcat-7.0.62/lib/ext/
	...
	cp /mnt/liferay/liferay.sh /etc/init.d
