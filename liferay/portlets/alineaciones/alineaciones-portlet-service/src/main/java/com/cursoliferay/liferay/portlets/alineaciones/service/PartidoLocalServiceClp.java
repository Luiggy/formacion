 ...
 * @generated
 */
public class PartidoLocalServiceClp implements PartidoLocalService {
    ...
    public PartidoLocalServiceClp(InvokableLocalService invokableLocalService) {
    ...
    public com.cursoliferay.liferay.portlets.alineaciones.model.Partido addPartido(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] { ClpSerializer.translateInput(partido) });
        } catch (Throwable t) {
        ...
        return (com.cursoliferay.liferay.portlets.alineaciones.model.Partido) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public com.cursoliferay.liferay.portlets.alineaciones.model.Partido createPartido(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName1,
                    _methodParameterTypes1, new Object[] { partidoId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.cursoliferay.liferay.portlets.alineaciones.model.Partido deletePartido(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName2,
                    _methodParameterTypes2, new Object[] { partidoId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.cursoliferay.liferay.portlets.alineaciones.model.Partido fetchPartido(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName10,
                    _methodParameterTypes10, new Object[] { partidoId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.cursoliferay.liferay.portlets.alineaciones.model.Partido getPartido(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName13,
                    _methodParameterTypes13, new Object[] { partidoId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<com.cursoliferay.liferay.portlets.alineaciones.model.Partido> getPartidos(
        ...
        return (java.util.List<com.cursoliferay.liferay.portlets.alineaciones.model.Partido>) ClpSerializer.translateOutput(returnObj);
    }
